export default [
  ...
  {
    question: 'The Organic Act of 1916 established the National Park Service in order to do what? ',
    options: ['Conserve natural lands', 'Conserve wildlife', 'Maintain lands for the enjoyment of future generations', 'All of the above'],
    correct: 3,
  ...
  },
  {
    ...
    options: ['4,000', '17,000', '20,000', '45,000'],
    correct: 2,
    explanation: 'Today, the National Park Service has over 20 thousand employees who work to protect the diverse cultural and recreational resources within the parks, advocate for the environment, and connect the public with this precious resource.'
  }
]
